...
class ControllerAccountDownload extends Controller {
	public function index() {
		...
		foreach ($results as $result) {
			if (file_exists(DIR_DOWNLOAD . $result['seller_id'] . '/' . $result['filename'])) {
				$size = filesize(DIR_DOWNLOAD . $result['seller_id'] . '/' . $result['filename']);
	...
	public function download() {
		...
		if ($download_info) {
			$file = DIR_DOWNLOAD . $download_info['seller_id'] . '/' . $download_info['filename'];
