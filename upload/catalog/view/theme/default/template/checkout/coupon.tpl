...
$('#button-voucher').on('click', function() {
	$.ajax({
		...
		success: function(json) {
			$('.alert').remove();
                     if (json['success']) {
                        $('.voucheralert').after('<div class="alert alert-success">' + json['success'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
                        } 
                     if (json['error']) {
				$('.voucheralert').after('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
			}
		}
	});
});
