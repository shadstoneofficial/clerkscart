<div class="modal-dialog modal-lg">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo $heading_title; ?> (<?php echo $text_freespace; ?> <?php echo round($dirsize, 2); ?> MB)</h4>
    </div>
...
$('#button-search').on('click', function(e) {
	var url = 'index.php?route=account/catalog/filemanager&token=<?php echo $token; ?>&directory=<?php echo $directory; ?>';
...
$('#button-upload').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file\']').val() != '') {
			...
			$.ajax({
				url: 'index.php?route=account/catalog/filemanager/upload&token=<?php echo $token; ?>&directory=<?php echo $directory; ?>',
				type: 'post',
				dataType: 'json',
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		$.ajax({
			url: 'index.php?route=account/catalog/filemanager/folder&token=<?php echo $token; ?>&directory=<?php echo $directory; ?>',
			type: 'post',
			dataType: 'json',
...
$('#modal-image #button-delete').on('click', function(e) {
	if (confirm('<?php echo $text_confirm; ?>')) {
		$.ajax({
			url: 'index.php?route=account/catalog/filemanager/delete&token=<?php echo $token; ?>',
			type: 'post',
			dataType: 'json',
