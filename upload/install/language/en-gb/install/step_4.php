...
$_['text_clerkscart_base']        = '<h2 class="text-center">Visit our site <a href="http://clerkscart.com">ClerksCart</a> to be keep up to date</h2><h3 class="text-center">Also ClerksCart is based on OpenCart 2.2 , so you can use almost all extensions for this version</h3>';
