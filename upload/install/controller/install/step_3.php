...
class ControllerInstallStep3 extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$output  = '<?php' . "\n";
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_CLERKSCART . '\');' . "\n\n";
      $output .= 'define(\'HTTP_CATALOG\', \'' . HTTP_CLERKSCART . '\');' . "\n\n";

			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'' . HTTP_CLERKSCART . '\');' . "\n\n";
      $output .= 'define(\'HTTPS_CATALOG\', \'' . HTTP_CLERKSCART . '\');' . "\n\n";
			...
			$output  = '<?php' . "\n";
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_CLERKSCART . 'admin/\');' . "\n";
			$output .= 'define(\'HTTP_CATALOG\', \'' . HTTP_CLERKSCART . '\');' . "\n\n";

			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'' . HTTP_CLERKSCART . 'admin/\');' . "\n";
			$output .= 'define(\'HTTPS_CATALOG\', \'' . HTTP_CLERKSCART . '\');' . "\n\n";
	...
	private function validate() {
		...
		if (!is_writable(DIR_CLERKSCART . 'config.php')) {
			$this->error['warning'] = $this->language->get('error_config') . DIR_CLERKSCART . 'config.php!';
		}

		if (!is_writable(DIR_CLERKSCART . 'admin/config.php')) {
			$this->error['warning'] = $this->language->get('error_config') . DIR_CLERKSCART . 'admin/config.php!';
		}
