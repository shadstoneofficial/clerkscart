...
class ControllerInstallStep2 extends Controller {
	...
	public function index() {
		...
		$data['config_catalog'] = DIR_CLERKSCART . 'config.php';
		$data['config_admin'] = DIR_CLERKSCART . 'admin/config.php';
		
		$data['image'] = DIR_CLERKSCART . 'image';
		$data['image_cache'] = DIR_CLERKSCART . 'image/cache';
		$data['image_catalog'] = DIR_CLERKSCART . 'image/catalog';
