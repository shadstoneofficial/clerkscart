...
$_['entry_seller_group_display']      = 'Seller Groups';
...
$_['entry_seller_approval']           = 'Seller Requires Approval';
$_['entry_seller_auto']               = 'Automatic Commission';
$_['entry_seller_commission']         = 'Seller Commission (%)';
$_['entry_seller']                    = 'Seller Terms';
$_['entry_seller_mail']               = 'New Seller Alert Mail';
...
$_['help_seller_group']               = 'Default seller group.';
$_['help_seller_group_display']       = 'Display seller groups that new customers can select to use such as wholesale and business when signing up.';
...
$_['help_seller_approval']            = 'Automatically approve any new seller who sign up.';
$_['help_seller_auto']                = 'Automatically add to balance when each order reaches the complete status.';
$_['help_seller_commission']          = 'The default seller commission percentage.';
$_['help_seller']                     = 'Forces people to agree to terms before an seller account can be created.';
$_['help_seller_mail']                = 'Send an email to the store owner when a new seller is registered.';
