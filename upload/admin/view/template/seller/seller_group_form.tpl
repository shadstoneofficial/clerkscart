    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-seller-group" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-prodlimit"><?php echo $entry_prodlimit; ?></label>
            <div class="col-sm-10">
              <input type="text" name="prodlimit" value="<?php echo $prodlimit; ?>" placeholder="<?php echo $entry_prodlimit; ?>" id="input-prodlimit" class="form-control" />
            </div>
          </div>          
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-imglimit"><?php echo $entry_imglimit; ?></label>
            <div class="col-sm-10">
              <input type="text" name="imglimit" value="<?php echo $imglimit; ?>" placeholder="<?php echo $entry_imglimit; ?>" id="input-imglimit" class="form-control" />
            </div>
          </div>          
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-downloadlimit"><?php echo $entry_downloadlimit; ?></label>
            <div class="col-sm-10">
              <input type="text" name="downloadlimit" value="<?php echo $downloadlimit; ?>" placeholder="<?php echo $entry_downloadlimit; ?>" id="input-downloadlimit" class="form-control" />
            </div>
          </div>
        </form>
      </div>
