        ...
        <div class="panel panel-default">
          ...
          <table class="table">
            <tbody>
              ...
              <tr>
                <td><?php echo $text_seller; ?>
                  <?php if ($seller) { ?>
                  (<a href="<?php echo $seller; ?>"><?php echo $seller_firstname; ?> <?php echo $seller_lastname; ?></a>)
                  <?php } ?></td>
                <td class="text-right"><?php echo $seller_commission; ?></td>
                <td class="text-center"><?php if ($seller) { ?>
                  <?php if (!$seller_commission_total) { ?>
                  <button id="button-sellercommission-add" data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip" title="<?php echo $button_commission_add; ?>" class="btn btn-success btn-xs"><i class="fa fa-plus-circle"></i></button>
                  <?php } else { ?>
                  <button id="button-sellercommission-remove" data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip" title="<?php echo $button_commission_remove; ?>" class="btn btn-danger btn-xs"><i class="fa fa-minus-circle"></i></button>
                  <?php } ?>
                  <?php } else { ?>
                  <button disabled="disabled" class="btn btn-success btn-xs"><i class="fa fa-plus-circle"></i></button>
                  <?php } ?></td>
...
// Seller
$(document).delegate('#button-sellercommission-add', 'click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/addsellercommission&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
			$('#button-sellercommission-add').button('loading');
		},
		complete: function() {
			$('#button-sellercommission-add').button('reset');
		},
		success: function(json) {
			$('.alert').remove();
...
$(document).delegate('#button-sellercommission-remove', 'click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/removesellercommission&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
			$('#button-sellercommission-remove').button('loading');
		},
		complete: function() {
			$('#button-sellercommission-remove').button('reset');
		},
		success: function(json) {
			$('.alert').remove();
			...
			if (json['success']) {
				...
				$('#button-sellercommission-remove').replaceWith('<button id="button-sellercommission-add" data-toggle="tooltip" title="<?php echo $button_sellercommission_add; ?>" class="btn btn-success btn-xs"><i class="fa fa-plus-circle"></i></button>');
			}
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
